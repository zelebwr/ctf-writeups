...
> This is the central hub for all challenges attempted and solved during the **%CTF_EVENT_NAME%** event. Each entry links to a detailed, reproducible write-up.
...
| **Challenges Attempted** | `%Number%`                               |
| **Primary Focus**        | `%e.g., Cryptography, Web Exploitation%` |

> 💡 **Overall Reflection**
> A brief summary of your experience. What went well? What was challenging? What would you focus on next time?
...
_A list of the primary tools and setup used during this event._
